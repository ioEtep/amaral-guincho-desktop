...
namespace Amaral_Guincho_Software
{
    class acessoCEP
    {
        ...
        {
            ConexaoCep.fechar();
            ConexaoCep.criar_Conexao();
            tabela_memoria = new DataTable();
            comando_sql = new MySqlDataAdapter(comando, ConexaoCep.Conectar);
        ...
        public Boolean buscaEndereco(String info_cep)
        {
            ...
            carregar_tabela("SELECT log_logradouro.log_tipo_logradouro, log_logradouro.log_no as logradouro,log_bairro.bai_no as bairro," +
